  ...
  <div id="main" style="margin-left: 0px; display: block;">
    ...
    <table class="table">
      <tr>
        ...
        <th>No of the Pages</th>
        <th> Weight of the Book </th>
      </tr>
<?php 
  error_reporting(0);
...
<td>".$resultt['PID']."</td>
<td>".$resultt['Title']."</td>
<td>".$resultt['Author']."</td>
<td>".$resultt['MRP']."</td>
<td>".$resultt['Price']."</td>
<td>".$resultt['Discount']."</td>
<td>".$resultt['Available']."</td>
<td>".$resultt['Publisher']."</td>
<td>".$resultt['Edition']."</td>
<td>".$resultt['Category']."</td>
<td>".$resultt['Description']."</td>
<td>".$resultt['Language']."</td>
<td>".$resultt['page']."</td>
<td>".$resultt['weight']."</td>
<td><a href ='../controller/edit-products.php?id=$resultt[PID]&titl=$resultt[Title]&autho=$resultt[Author]&msp=$resultt[MRP]&pri=$resultt[Price]&dis=$resultt[Discount]&ava=$resultt[Available]&pub=$resultt[Publisher]&edi=$resultt[Edition]&cat=$resultt[Category]&des=$resultt[Description]&lan=$resultt[Language]&pge=$resultt[page]&wei=$resultt[weight]'>edit</td>
</tr>
    ";
  }
}
