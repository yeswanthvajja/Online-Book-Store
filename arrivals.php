...
<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:rgb(228, 55, 25);text-transform:uppercase;margin-bottom:0px;"> New Arrivals </h2>
           </div>
        </div>   
		
		<?php
			include("config.php");
			$query = "SELECT * FROM products WHERE Category='arrivals' ORDER BY Price";
