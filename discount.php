...
<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:rgb(228, 55, 25);text-transform:uppercase;margin-bottom:0px;"> Upto 50% off </h2>
           </div>
        </div>   
		
		<?php
			include("config.php");
			$query = "SELECT * FROM products WHERE Category='Discount page' ORDER BY Price";
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="book-block" style="border :3px solid #DEEAEE;">
                        ...
                        <hr>
                         ' . $row["Title"] . '<br>
                        $' . $row["Price"] .'  &nbsp
                        <span style="text-decoration:line-through;color:rgb(61, 158, 228);"> ' . $row["MRP"] .' </span>
