...
<html lang="en">
<head>
    <title>Login at There's Book For That!!</title>
    <meta charset="utf-8">
...
<body>
  <div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
          <a class="navbar-brand" href="home.php">There's Book For That!!</a>
  ...
  <h3>Login</h3>
    ...
    <a href = "adminLogin.php" style = "color: aliceblue;"> Admin Login </a><br><br>
  
        <a href = "register.php" style = "color: aliceblue;">Don't have an account? Register Here </a><br><br>
    <button type="submit" class="btn btn-primary" name = "loginsubmit" style="background-color: blue;box-shadow: 2px 2px white; id="login-button"">Submit</button>
    </form>
  </div>
